...
const UserVerificationPage: React.FC = () => {
  const [assets, setAssets] = useState<AssetVerification[]>([
    { id: '1', name: 'MacBook Pro 16"', expectedId: 'AST-9042', enteredId: '', isLost: false, type: 'Laptop' },
    { id: '2', name: 'Logitech MX Master 3', expectedId: 'AST-8742', enteredId: '', isLost: false, type: 'Mouse' },
    { id: '3', name: 'Apple USB-C Charger 140W', expectedId: 'AST-4421', enteredId: '', isLost: false, type: 'Charger' },
    { id: '4', name: 'Jabra Evolve2 Headset', expectedId: 'AST-1192', enteredId: '', isLost: false, type: 'Audio' },
  ]);
